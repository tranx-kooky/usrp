...
# Author: operateur
# GNU Radio version: v3.11.0.0git-1029-g3c48f5e2

from PyQt5 import Qt
from gnuradio import qtgui
from gnuradio import analog
from gnuradio import blocks
import AddMulBlock_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading
...
class AddMulBlock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AddMulBlock")
        ...
        self.epy_block_0 = epy_block_0.blk(addflag=False)
...
def main(top_block_cls=AddMulBlock, options=None):

...
class sinewave(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "sinewave", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sinewave")
        ...
        self._freq_range = qtgui.Range(-samp_rate/2, samp_rate/2, 100, 00, 200)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.frequencyShifter_0.set_frequency(self.freq)
